 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param tokenid TokenId to request metadata for
 * @param optional nil or *GetTokenMetadataOpts - Optional Parameters:
 * @param "Verbosity" (optional.Float32) -  0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses
@return GetTokenMetadataResponse
*/

type GetTokenMetadataOpts struct {
	Verbosity optional.Float32
}

func (a *NTP1ApiService) GetTokenMetadata(ctx context.Context, tokenid string, localVarOptionals *GetTokenMetadataOpts) (GetTokenMetadataResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	if localVarOptionals != nil && localVarOptionals.Verbosity.IsSet() {
		localVarQueryParams.Add("verbosity", parameterToString(localVarOptionals.Verbosity.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
 ...
 * @param optional nil or *GetTokenMetadataOfUtxoOpts - Optional Parameters:
 * @param "Verbosity" (optional.Float32) -  0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses
@return GetTokenMetadataResponse
*/

type GetTokenMetadataOfUtxoOpts struct {
	Verbosity optional.Float32
}

func (a *NTP1ApiService) GetTokenMetadataOfUtxo(ctx context.Context, tokenid string, utxo string, localVarOptionals *GetTokenMetadataOfUtxoOpts) (GetTokenMetadataResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string

 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param tokenid TokenId to request metadata for
 * @param optional nil or *TestnetGetTokenMetadataOpts - Optional Parameters:
...
type TestnetGetTokenMetadataOpts struct {
	Verbosity optional.Float32
}

func (a *TestnetNTP1ApiService) TestnetGetTokenMetadata(ctx context.Context, tokenid string, localVarOptionals *TestnetGetTokenMetadataOpts) (GetTokenMetadataResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @param optional nil or *TestnetGetTokenMetadataOfUtxoOpts - Optional Parameters:
 * @param "Verbosity" (optional.Float32) -  0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses
@return GetTokenMetadataResponse
*/

type TestnetGetTokenMetadataOfUtxoOpts struct {
	Verbosity optional.Float32
}

func (a *TestnetNTP1ApiService) TestnetGetTokenMetadataOfUtxo(ctx context.Context, tokenid string, utxo string, localVarOptionals *TestnetGetTokenMetadataOfUtxoOpts) (GetTokenMetadataResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string

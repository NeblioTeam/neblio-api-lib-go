...
# **GetAddressBalance**
> float32 GetAddressBalance(ctx, address)
...
> float32 GetAddressTotalReceived(ctx, address)
...
# **GetAddressTotalSent**
> float32 GetAddressTotalSent(ctx, address)
...
> float32 GetAddressUnconfirmedBalance(ctx, address)
...
# **GetAddressUtxos**
> []map[string]interface{} GetAddressUtxos(ctx, address)
...
# **GetStatus**
> map[string]interface{} GetStatus(ctx, optional)
...
# **SendTx**
> BroadcastTxResponse SendTx(ctx, sendTxRequest)
